...
class PredictionRequest(BasicMasterRequest):
    ...
    def run(self):
        uri = "http://"+self.target_host+":"+self.target_port+"/doPrediction?keyphrase="+KEYPHRASE + "&use_transition=" + str(self.use_transition) + "&no_samples="+str(self.no_samples) + "&process="+str(self.process)
